      ...
      child: Column(
        children:[
          ...
          const Padding(
            ...
            child: Text("Description",style: TextStyle(fontSize: 24, color:Colors.black),),
          ),
           SizedBox(
            height: 300,
          ...
          const Divider(
            ...
            Container(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    const Text("GHC 1200 per person",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500),),
                ...
                children:const [
                 ...
                 SizedBox(width: 100,),
                  Text("BU",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w300),)
                ],
            ),
            const SizedBox(height: 20,),
             Row(
                children:const [
                 ...
                 SizedBox(width: 100,),
                  Text("Single",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w300),)
                ],
            ),
            const SizedBox(height: 20,),
             Row(
                children:const [
                 ...
                 SizedBox(width: 80,),
                  Text("Water and Electricity available",softWrap: false,style: TextStyle(fontSize: 17,fontWeight: FontWeight.w300),)
                ],
            ),
            const SizedBox(height: 20,),
             Row(
                children:const [
                 ...
                 SizedBox(width: 100,),
                  Text("For rent",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w300),)
                ],
            )
                  ],
                ),
