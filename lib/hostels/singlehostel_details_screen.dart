...
class DetailsScreen extends StatelessWidget {
  final SingleHostel singleHostel;
  
   const DetailsScreen(this.singleHostel, {Key? key}) : super(key: key);
      ...
      child: Column(
        children:[
                 ...
                 Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image:  DecorationImage(
                      image: AssetImage(singleHostel.picture),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
          ...
          Padding(
            ...
            child: Text(singleHostel.title,style: const TextStyle(fontWeight: FontWeight.w700,fontSize: 20),),
          ),
          const Divider(
            height: 1,
            ),
