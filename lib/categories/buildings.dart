...
class Buildings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("BUILDINGS",style: TextStyle(color: kPrimaryColor),),
        ...
        children:[
          const SizedBox(
           ...
           const Padding(
            ...
            child: Text("Completed Buildings For Sale",style: TextStyle(fontSize: 20),),
          ),
          SizedBox(
            height: 300,
    ...
    const SizedBox(
     ...
     const Padding(
            padding: EdgeInsets.all(8.0),
            child: Text("Uncompleted Buildings For Sale",style: TextStyle(fontSize: 20),),
          ),
           SizedBox(
            height: 300,
            width: double.infinity,
